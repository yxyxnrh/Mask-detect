...
class MainWindow(QTabWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle('实验2 - 口罩检测')
        self.resize(1200, 800)
        self.setWindowIcon(QIcon("images/UI/1.png"))
        self.output_size = 480
        self.img2predict = ""
        self.device = 'cpu'  #修改cpu 为 0
        self.vid_source = '0'
    ...
    def initUI(self):
        ...
        self.left_img.setPixmap(QPixmap("images/UI/1.png"))
        ...
        self.left_img.setAlignment(Qt.AlignCenter)
        self.addTab(img_detection_widget, '口罩检测')
    ...
    def upload_img(self):
        ...
        if fileName:
            ...
            cv2.imwrite("images/tmp/1.png", im0)
            # self.right_img.setPixmap(QPixmap("images/tmp/single_result.jpg"))
            self.img2predict = fileName
            self.left_img.setPixmap(QPixmap("images/tmp/1.png"))
            # todo 上传图片之后右侧的图片重置，
            self.right_img.setPixmap(QPixmap("images/UI/1.png"))
    ...
    ***检测图片***
    ...
    def detect_img(self):
        ...
        print(source)
        if source == "":
            QMessageBox.warning(self, "上传", "上传口罩图片再检测")
        else:
            source = str(source)
            ...
            for path, im, im0s, vid_cap, s in dataset:
                ...
                for i, det in enumerate(pred):  # per image
                    ...
                    self.right_img.setPixmap(QPixmap("images/tmp/1.png"))
    ...
    def detect_vid(self):
        ...
        for path, im, im0s, vid_cap, s in dataset:
            ...
            for i, det in enumerate(pred):  # per image
                ...
                cv2.imwrite("images/tmp/1.png", frame_resized)
                self.vid_img.setPixmap(QPixmap("images/tmp/1.png"))
